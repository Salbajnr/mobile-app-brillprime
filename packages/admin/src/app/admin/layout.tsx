...
const navItems = [
  ...
  { href: '/admin/user-management', icon: Users, label: 'User Management', badge: 23 },
  { href: '/admin/escrow', icon: Package, label: 'Escrow Management', badge: 7 },
  { href: '/admin/transactions', icon: ArrowRightLeft, label: 'Transactions', badge: 3 },
  { href: '/admin/support', icon: Ticket, label: 'Support & Tickets', badge: 15 },
  { href: '/admin/demand-planning', icon: BarChart, label: 'Demand Planning' },
  { href: '/admin/security', icon: ShieldCheck, label: 'Security & Fraud', pulse: true },
];
          ...
          <header className="sticky top-0 z-10 flex h-16 items-center gap-4 border-b bg-white px-6">
            ...
            <div>
              <h1 className="text-xl md:text-2xl font-bold text-foreground capitalize">
                {breadcrumbTitle === 'admin' ? 'Dashboard' : breadcrumbTitle}
              </h1>
